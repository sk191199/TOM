  ...
  return (
    <div>
      {!showForm ? (
        ...
        <Box sx={{ p: { xs: 2, md: 3 }, backgroundColor: "#f5f7fb", minHeight: "calc( 100vh - 56px)" }}>
          ...
          >
            <Typography variant="h6" sx={{ display: "flex", alignItems: "center", gap: 1 }}>
              <span role="img" aria-label="doc">🧾</span> Sales Order List
            </Typography>
                ...
                <Card key={r.id} variant="outlined">
                  <CardContent sx={{ display: "flex", justifyContent: "space-between", gap: 2 }}>
                    <Box>
                      ...
                      <Typography variant="body2">Type: {r.docType}</Typography>
                    </Box>
        ...
        /* ======= Sales Order Preparation Form (shown after New) ======= */
        <Box sx={{ p: { xs: 2, md: 3 }, backgroundColor: "#f5f7fb", minHeight: "100vh" }}>
          ...
          >
            <Typography variant="h6">Sales Order Preparation</Typography>
