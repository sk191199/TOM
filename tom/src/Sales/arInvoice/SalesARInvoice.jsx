...
import { Box, Button, Typography, Paper, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Card, CardContent, Checkbox, IconButton, TextField, MenuItem, Select, FormControl, InputLabel, } from "@mui/material";
...
const SalesARInvoice = () => {
    ...
    return (
        <div>
            {!showForm ? (
                /* ======= Sales Invoice List (initial page) ======= */
                // <SalesList rows={rows} selected={selected} setSelected={setSelected} isMobile={isMobile} setShowForm={setShowForm} />
                ...
                /* ======= Sales Invoice Preparation Form (shown after New) ======= */
                <Box sx={{ p: { xs: 2, md: 3 }, backgroundColor: "#f5f7fb", minHeight: "100vh" }}>
                    ...
                    >
                        <Typography variant="h6">AR Invoice Preparation</Typography>
                        ...
                        <Box sx={{ display: "flex", gap: 1, flexWrap: "wrap" }}>
                            ...
                            <Button variant="outlined" startIcon={<SwapHorizOutlinedIcon />} sx={{ flex: { xs: "1 1 100%", sm: "auto" } }}>
                                Convert to Order
                            </Button>
                            <Button variant="contained" color="error" startIcon={<DoneIcon />} sx={{ flex: { xs: "1 1 100%", sm: "auto" } }}>
                                Submit
                            </Button>
                        </Box>
                    </Box>
                        ...
                        >
                            ...
                            <FormControl sx={{ flex: "1 1 365px" }} size="small" fullWidth >
                                ...
                                >
                                    ...
                                    <MenuItem value="">-- Select --</MenuItem>
                                    <MenuItem value="C001">Name A</MenuItem>
                                    <MenuItem value="C002">Name B</MenuItem>
                                </Select>
                            </FormControl>
                            <TextField
                                size="small"
                    ...
                    <Paper sx={{ p: 2, mb: 2 }}>
                        ...
                        >
                            ...
                            >
                                <MenuItem value="">-- Select --</MenuItem>
                                <MenuItem value="sub-1">Subsidary 1</MenuItem>
                            </TextField>
                    ...
                    <Paper sx={{ p: 3, mb: 2 }}>
                        <Box sx={{ width: "100%", display: "flex", alignItems: "center", justifyContent: "space-between", mb: 2 }}>
                            <Box sx={{ width: "80%" }}>
                                <Box sx={{ display: "flex", gap: 2, flexWrap: "wrap", "& > *": { flex: { xs: "1 1 100%", md: "1 1 30%" } }, }}>
                                ...
                                <Typography variant="subtitle1" sx={{ fontWeight: "bold", margin: "1rem 0px 0.5rem 0px" }}>
                                    Extra Invoice Details
                                </Typography>

                                <Box sx={{ display: "flex", gap: 2, flexWrap: "wrap", mb: 2 }}>
                                    <Box sx={{ display: "flex", gap: 2, }}>
                                        <TextField label="E-Way Bill No" value={form.billToAddress} onChange={(e) => handleFormChange("ewayBillNo", e.target.value)} sx={{ flex: { xs: "1 1 100%", md: "1 1 49%" } }} />
                                        <Button variant="outlined" >Genarate E-Way Bill</Button>
                                    </Box>
                                    <Box sx={{ display: "flex", gap: 2, }}>
                                        <TextField label="IRN No" value={form.shipToAddress} onChange={(e) => handleFormChange("IRNNo", e.target.value)} sx={{ flex: { xs: "1 1 100%", md: "1 1 49%" } }} />
                                        <Button variant="outlined" >Genarate IRN No</Button>
                                    </Box>
                                </Box>
                            </Box>
                            {/* QR */}
                            <Box sx={{ width: "20%", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "start", gap: 1 }}>
                                <Box sx={{ border: "1px solid grey", height: "8rem", width: "8rem", display: "flex", justifyContent: "center", alignItems: "center" }}>
                                    {(qrData !== "") &&
                                ...
                                <Button variant="outlined" onClick={() => setQrData("ArInvoice")}>Generate QR</Button>
                            </Box>
                        </Box>
                    ...
                    <Paper sx={{ p: 2 }}>
                        ...
                        <TextField placeholder="Enter Terms and Conditions Here" multiline rows={4} fullWidth value={form.terms} onChange={(e) => handleFormChange("terms", e.target.value)} />
                    </Paper>
                </Box>
            )}
        </div>
